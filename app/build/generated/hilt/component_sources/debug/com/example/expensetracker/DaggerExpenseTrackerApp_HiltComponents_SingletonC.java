...
import com.example.expensetracker.di.AppModule_ProvideExpenseDaoFactory;
import com.example.expensetracker.di.AppModule_ProvideExpenseDatabaseFactory;
import com.example.expensetracker.di.AppModule_ProvideExpenseRepositoryFactory;
...
import com.example.expensetracker.ui.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.example.expensetracker.ui.statistics.StatisticsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerExpenseTrackerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends ExpenseTrackerApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(StatisticsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends ExpenseTrackerApp_HiltComponents.ViewModelC {
    ...
    private AddExpenseUseCase addExpenseUseCase() {
      return new AddExpenseUseCase(singletonCImpl.provideExpenseRepositoryProvider.get());
    }

    private DeleteExpenseUseCase deleteExpenseUseCase() {
      return new DeleteExpenseUseCase(singletonCImpl.provideExpenseRepositoryProvider.get());
    }

    private GetExpenseStatsUseCase getExpenseStatsUseCase() {
      return new GetExpenseStatsUseCase(singletonCImpl.provideExpenseRepositoryProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.expensetracker.ui.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.example.expensetracker.ui.statistics.StatisticsViewModel", ((Provider) statisticsViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.expensetracker.ui.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.provideExpenseRepositoryProvider.get(), viewModelCImpl.addExpenseUseCase(), viewModelCImpl.deleteExpenseUseCase());

          case 1: // com.example.expensetracker.ui.statistics.StatisticsViewModel 
          return (T) new StatisticsViewModel(viewModelCImpl.getExpenseStatsUseCase());
  ...
  private static final class SingletonCImpl extends ExpenseTrackerApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideExpenseDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<ExpenseDatabase>(singletonCImpl, 2));
