...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  private FragmentAboutBinding(@NonNull LinearLayout rootView, @NonNull TextView tvAppName,
      @NonNull TextView tvDescription, @NonNull TextView tvVersion) {
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAboutBinding((LinearLayout) rootView, tvAppName, tvDescription, tvVersion);
    }
